...
function wiser_setup(): void {
	/*
		...
		* If you're building a theme based on Wiser, use a find and replace
		* to change 'wiser' to the name of your theme in all the template files.
		*/
